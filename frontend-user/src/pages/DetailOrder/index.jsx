    ...
    <main className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 sm:pb-60 lg:px-8">
      <div className="max-w-3xl">
        ...
        <dl className="mt-12 grid flex-1 grid-cols-2 gap-6 text-sm sm:col-span-4 sm:grid-cols-4 lg:col-span-2">
          <div>
            <dt className="font-medium text-slate-900">Mã đơn hàng</dt>
            <dd className="mt-1 font-medium text-sky-600">{order.id}</dd>
          </div>
          <div className="sm:col-span-2">
            <dt className="font-medium text-slate-900">Ngày đặt</dt>
            <dd className="mt-1 font-medium text-sky-600">{order.ngayDat}</dd>
          </div>
          <div>
            <dt className="font-medium text-slate-900">Trạng thái thanh toán</dt>
      ...
      <div className="mt-10 border-t border-slate-200">
        ...
        <div className="sm:ml-40 sm:pl-6">
          <dl className="grid grid-cols-1 gap-x-6 py-8 text-sm">
            <div>
              <dt className="font-medium text-slate-900">Thông tin giao hàng</dt>
          ...
          <dl className="grid grid-cols-1 gap-x-6 border-t border-slate-200 py-8 text-sm">
            <div>
              <dt className="font-medium text-slate-900">Phương thức thanh toán</dt>
              <dd className="mt-2 text-slate-700/80">
                <p>{order.phuongThucThanhToan || "Không có thông tin"}</p>
              </dd>
            </div>
          </dl>
          ...
          <dl className="space-y-6 border-t border-slate-200 pt-8 text-sm">
            <div className="flex justify-between">
              <dt className="font-medium text-slate-900">Giá trị đơn hàng</dt>
            ...
            <div className="flex justify-between">
              <dt className="font-medium text-slate-900">Phí vận chuyển</dt>
              <dd className="text-slate-700/80">0</dd>
            </div>
            <div className="flex justify-between">
              <dt className="font-medium text-slate-900">Thuế</dt>
              <dd className="text-slate-700/80">0</dd>
            </div>
            <div className="flex justify-between">
              <dt className="font-medium text-slate-900">Tổng thanh toán</dt>
